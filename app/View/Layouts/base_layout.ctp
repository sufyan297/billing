...
<head>
    ...
    <title><?php echo $page_title; ?> - Orange Mobile</title>
    ...
    <header class="main-header">
      <!-- Logo -->
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Orange</b>Mobile</span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?= date('Y') ?> <a href="#">Orange Mobile</a>.</strong> All rights
        reserved.
      </footer>
